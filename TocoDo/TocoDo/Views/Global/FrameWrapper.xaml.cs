...
namespace TocoDo.UI.Views.Global
{
	...
	public partial class FrameWrapper : Frame
	{
		...
		{
			if (propertyChangedEventArgs.PropertyName == nameof(InnerContent)) Grid.Children.Add(InnerContent, 0, 2);
		}

		#region Backing fields

		public static BindableProperty InnerContentProperty =
			BindableProperty.Create(nameof(InnerContent), typeof(View), typeof(View));

		public static BindableProperty HeaderProperty =
			BindableProperty.Create(nameof(Header), typeof(string), typeof(string), string.Empty);

		public static BindableProperty HeaderBackgroundColorProperty =
			BindableProperty.Create(nameof(HeaderBackgroundColor), typeof(Color), typeof(Color), Color.Gray);

		public static BindableProperty HeaderTextColorProperty =
			BindableProperty.Create(nameof(HeaderTextColor), typeof(Color), typeof(Color), Color.White);
